...
talked about getting rid of the worst-case relative error; it’s distracting.  we also talked about exactly what plots to show, but now i’ve forgotten what they would be.

we also talked about explaining more about the centralized algorithm.    you can cite CVX and the papers that describe canonicalization and DCP.

in both subsections of \S5 , you need to remind the reader that the algorithm solves the problem (assuming it has a solution)
